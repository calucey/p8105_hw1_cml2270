...
Use ggplot to generate a scatterplot of flipper vs. bill length for all three species. Label the axes, indicate points should be colored according to species, and save using ggsave().
